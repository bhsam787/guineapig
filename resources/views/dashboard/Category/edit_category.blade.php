...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit Catgeory</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit catgeory Details</h3>
                        <a href="{{ route('category.index') }}" class="btn btn-sm btn-success float-right"><i class="fa fa-list mr-1"></i> View Catgeory </a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
